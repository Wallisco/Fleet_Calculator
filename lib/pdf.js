...
function buildSavingsPdf(payload) {
  return new Promise((resolve, reject) => {
    ...
    /* footer */
    const DISC = 'Estimates only. Petrol cost per kilometre is derived from the pump price shown and a fixed 24 km per litre, typical for a ' +
      ...
      'and tracking. All figures exclude VAT. Savings move with the petrol price.';
